...
def saveOriginalDataToDatabase(msgId, movieId, movieName, originalData):
    conn = mysql.connector.connect(user='root', password='123456', database='hhjdemo')
    cursor = conn.cursor()
    ins = "insert into originalData (id, movie_id, original_info, movie_name) values (%s, %s, %s, %s)"
...
if __name__ == '__main__':
    ...
    saveOriginalDataToDatabase("111", "222", "333", "444")
